...
public class ElevatorConstants {
    ...
    public static final double BALL_LOW_INTAKE = 0;
    public static final double BALL_HEIGH_INTAKE = 0;
    ...
    public static final State BALL_SORTING = new State("BALL_SORTING", Elevator.getInstance());
    ...
    public static final State CORAL_HOLD = new State("CORAL_HOLD ", Elevator.getInstance());
