...
public class Field {
        ...
        public static enum ScoringLevel {
                ...
                ScoringLevel(double ScoringHeight, double ScoringAngle, double EjectVolt) {
        ...
        public static enum BallHeight {
                HIGH(ElevatorConstants.BALL_HIGH_INTAKE_HEIGHT), // HIGHT_EJECT_BALL_HIGH
                LOW(ElevatorConstants.BALL_LOW_INTAKE_HEIGHT),
                NONE(0);

                public final double elevatorHeight;

                BallHeight(double ElevatorHeight) {
        ...
        private static ReefFace blankFace = new ReefFace(0, 0, BallHeight.NONE, new Pose2d());
